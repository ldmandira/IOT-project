...
import com.example.smartdoor.HelperClasses.UniqueUserHelperClass;
    ...
    protected void onCreate ( Bundle savedInstanceState ) {
        ...
        sinemenu.setOnClickListener ( new OnClickListener ( ) {
            ...
            public void onClick ( View v ) {
                ...
                {
                    Toast.makeText( com.example.smartdoor.signpage.this, "Password do not match", Toast.LENGTH_SHORT).show();
                }
        ...
        databaseReference.addListenerForSingleValueEvent ( new ValueEventListener ( ) {
            ...
            public void onDataChange ( @NonNull DataSnapshot snapshot ) {
                if (snapshot.child ( uniqueUserHelperClass.getUserNIC ()).exists ()){
                    Toast.makeText ( com.example.smartdoor.signpage.this , "Sorry.. this NIC already registered" , Toast.LENGTH_SHORT ).show ( );
            ...
            public void onCancelled ( @NonNull DatabaseError error ) {
                Toast.makeText ( com.example.smartdoor.signpage.this , "Sorry.. Please try again.." , Toast.LENGTH_SHORT ).show ( );
                spb.setVisibility ( View.INVISIBLE );
            }
        } );
                ...
                if (task.isSuccessful ( )) {
                    ...
                    firebaseDatabase.getInstance ( ).getReference ( "Users" ).child ( saveUserNIC )
                        ...
                        public void onComplete ( @NonNull Task<Void> task ) {
                            spb.setVisibility ( View.INVISIBLE );
                            Toast.makeText ( com.example.smartdoor.signpage.this , "Your Account is created Successfully" , Toast.LENGTH_SHORT ).show ( );
                            startActivity ( new Intent ( getApplicationContext (),MainActivity.class  ) );
                        }
                    } );
                    ...
                    Toast.makeText ( com.example.smartdoor.signpage.this , "Error ! " + task.getException ( ).getMessage ( ) , Toast.LENGTH_SHORT ).show ( );
                    Toast.makeText ( com.example.smartdoor.signpage.this , "Error ! Your Account is created Unsuccessfully" , Toast.LENGTH_SHORT ).show ( );
